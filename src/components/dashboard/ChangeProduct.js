...
import { changeProduct } from '../../actions/products.js'
...
class CreateProduct extends Component {
    ...
    setStateProduct = () => {
       const { products, productId } = this.props.products 
    ...
    onSubmit = e => {
        e.preventDefault()
        const { productId } = this.props.products
        ...
        this.props.changeProduct( productId, productData, this.props.history)
    }
    ...
    render() {
        ...
        <div className="card card-body mt-5">
          <h2 className="text-center">Changed Product</h2>
...
export default connect(mapStateToProps, {changeProduct})(CreateProduct)
